...
import { Injectable, Directive, Input, NgModule, CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA, ChangeDetectorRef, ɵɵdefineInjectable, Component, ChangeDetectionStrategy, ViewChild, ɵɵinject } from '@angular/core';
...
var ActionsAndToolsConfig = /** @class */ (function () {
    function ActionsAndToolsConfig(name, enable, token, level, type, icon, nodePropertyName, isApp) {
        this.name = name;
        this.enable = enable;
        this.token = token;
        this.level = level;
