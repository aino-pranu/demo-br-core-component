(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var EnterpriseGridService = /** @class */ (function () {
        ...
        /** @nocollapse */ EnterpriseGridService.ngInjectableDef = i0.ɵɵdefineInjectable({ factory: function EnterpriseGridService_Factory() { return new EnterpriseGridService(); }, token: EnterpriseGridService, providedIn: "root" });
    ...
    var ActionConfig = /** @class */ (function () {
         ...
         */
        function ActionConfig(name, enable, token, isBulk, type, positionType, icon$$1, iconName, tooltip$$1) {
            this.name = name;
            this.enable = enable;
            this.token = token;
            this.isBulk = isBulk;
    ...
    var EnterpriseGridComponent = /** @class */ (function () {
        ...
        */
         ...
         */
            function () {
                /** @type {?} */
                var table$$1 = document.getElementsByTagName("tr");
                for (var i = 0; i < table$$1.length;) {
                    (( /** @type {?} */(table$$1[i]))).remove();
                }
            };
        /**
        ...
        /** @nocollapse */
        EnterpriseGridComponent.ctorParameters = function () {
            return [
        ...
        /** @nocollapse */ EnterpriseGridComponent.ngInjectableDef = i0.ɵɵdefineInjectable({ factory: function EnterpriseGridComponent_Factory() { return new EnterpriseGridComponent(i0.ɵɵinject(EnterpriseGridService), i0.ɵɵinject(i0.ChangeDetectorRef)); }, token: EnterpriseGridComponent, providedIn: "root" });
    ...
    var AoGridDataDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        AoGridDataDirective.ctorParameters = function () {
            return [
                { type: EnterpriseGridComponent }
            ];
        };
        AoGridDataDirective.propDecorators = {
            gridData: [{ type: i0.Input }]
        };
    ...
    var AoGridConfigDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        AoGridConfigDirective.ctorParameters = function () {
            return [
                { type: EnterpriseGridComponent }
            ];
        };
        AoGridConfigDirective.propDecorators = {
            gridConfig: [{ type: i0.Input }]
        };
    ...
    var PagingConfig = /** @class */ (function () {
        function PagingConfig(name, enable, token, pagingType, icon$$1, iconName, tooltip$$1) {
            this.name = name;
            this.enable = enable;
            this.token = token;
    ...
    var GridConfig = /** @class */ (function () {
         ...
         * @return {?}
         */
            function (name, enable, token, isBulk, type, positionType, isIcon, iconName, tooltip$$1) {
                this.actionConfigArr.push(new ActionConfig(name, enable, token, isBulk, type, positionType, isIcon, iconName, tooltip$$1));
            };
        /**
         * @param {?} name
         * @param {?} enable
         ...
         * @return {?}
         */
            function (name, enable, token, pagingType, icon$$1, iconName, tooltip$$1) {
                this.pagingConfigArr.push(new PagingConfig(name, enable, token, pagingType, icon$$1, iconName, tooltip$$1));
            };
