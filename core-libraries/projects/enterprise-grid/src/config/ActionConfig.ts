/**
 * ActionConfig class for configuring entity, core, bulk and non-bulk actions.
 */
export class ActionConfig {
    ...
    // action enable boolean value
    public enable: boolean;

    // action token e.g. on-button-click
    public token: string;

    // bulk action boolean value
    public isBulk: boolean;

    // action type (hover or core)
    public type: string;

    // action position type (whether in-place or in-selector)
    public positionType: string;

    // whether icon action, boolean value
    public isIcon: boolean;

    // action icon name/text to be displayed.
     ...
     * @param isBulk bulk action boolean value
